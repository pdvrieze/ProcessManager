 ...
 */
fun <T : ContextProcessTransaction, N : ProcessNodeInstance<*, *>> N?.mustExist(handle: PNIHandle): N = this ?: throw IllegalStateException("Node instance missing: $handle")
 ...
 */
fun <T : ContextProcessTransaction, N : ProcessNodeInstance<*, *>> N?.shouldExist(handle: PNIHandle): N = this ?: throw HandleNotFoundException("Node instance missing: $handle")
 ...
 * @throws IllegalStateException If it doesn't
 */
fun <T : ContextProcessTransaction, C : ActivityInstanceContext> ProcessInstance<C>?.mustExist(handle: PIHandle): ProcessInstance<C> = this ?: throw IllegalStateException("Node instance missing: $handle")
 ...
 * @throws HandleNotFoundException If it doesn't.
 */
fun <T : ContextProcessTransaction, C : ActivityInstanceContext> ProcessInstance<C>?.shouldExist(handle: PIHandle): ProcessInstance<C> = this ?: throw HandleNotFoundException("Node instance missing: $handle")

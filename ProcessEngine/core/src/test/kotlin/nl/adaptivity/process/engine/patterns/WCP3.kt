...
private const val WCP3_expectedJson = "{\"name\":\"WCP3\",\"owner\":\"pdvrieze\",\"roles\":null,\"uuid\":null,\"childModel\":[],\"import\":[],\"export\":[],\"nodes\":[" +
                                      ...
                                      "[\"nl.adaptivity.process.processModel.engine.XmlActivity\",{\"isMultiInstance\":false,\"x\":NaN,\"y\":NaN,\"define\":[],\"result\":[],\"id\":\"ac1\",\"label\":null,\"message\":null,\"name\":null,\"childId\":null,\"predecessor\":\"split\"}]," +
                                      "[\"nl.adaptivity.process.processModel.engine.XmlActivity\",{\"isMultiInstance\":false,\"x\":NaN,\"y\":NaN,\"define\":[],\"result\":[],\"id\":\"ac2\",\"label\":null,\"message\":null,\"name\":null,\"childId\":null,\"predecessor\":\"split\"}]," +

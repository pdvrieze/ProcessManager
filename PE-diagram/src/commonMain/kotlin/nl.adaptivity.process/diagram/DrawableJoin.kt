...
class DrawableJoin(
    ...
    builder, buildHelper, otherNodes
), Join, DrawableJoinSplit {
    ...
    class Builder : JoinBase.Builder, DrawableJoinSplit.Builder<DrawableJoin>, IDrawableJoin {
        ...
        constructor(
            ...
            id, predecessors, successor, label, defines, results,
        ...
        override fun copy(): Builder =
            Builder(
                id, predecessors, successor?.identifier, label, defines, results, x, y, min, max, state,

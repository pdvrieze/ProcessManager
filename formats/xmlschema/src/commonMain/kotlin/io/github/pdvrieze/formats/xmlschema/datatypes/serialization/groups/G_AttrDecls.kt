...
import io.github.pdvrieze.formats.xmlschema.datatypes.serialization.types.T_Attribute
...
interface G_AttrDecls {
    val atributes: List<T_Attribute>
    /** Name elements AttributeGroup */
    val atributeGroups: List<T_AttributeGroupRef>
    val anyAttributes: List<XSAnyAttribute>
}

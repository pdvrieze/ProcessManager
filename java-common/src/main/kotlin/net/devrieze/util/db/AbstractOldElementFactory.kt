 ...
 */
abstract class AbstractOldElementFactory<T, TR : Transaction> : OldHMElementFactory<T, TR> {
  ...
  @Throws(SQLException::class)
  override fun postStore(connection: TR, handle: Handle<out T>, oldValue: T, newValue: T) {

 ...
 */
abstract class AbstractTransactionedHandleMap<V, T : Transaction> : OldTransactionedHandleMap<V, T> {
  ...
  @Deprecated("")
  override fun get(handle: Long): V? {
    return get(Handles.handle<V>(handle))
  }

 ...
 */
internal class XMLFragmentStreamReader @Throws(XmlException::class)
  ...
  : XmlDelegatingReader(XMLFragmentStreamReader.getDelegate(reader, wrapperNamespaceContext))
{
  ...
  companion object
  {
    ...
    @Throws(XmlException::class)
    private fun getDelegate(reader: Reader, wrapperNamespaceContext: Iterable<nl.adaptivity.xml.Namespace>): XmlReader
    {
...
fun CompactFragment.getXmlReader(): XmlReader
  = XMLFragmentStreamReader.from(this)
...
class SigningService(serviceName: ServiceName<SigningService>, authService: AuthService, adminAuth: PmaAuthInfo):
    AbstractRunnableUiService<SigningService>(authService, adminAuth, serviceName), AutomatedService {

...
sealed class PmaAction<I : Any, O : Any, C : AbstractDynamicPmaActivityContext<C, *>> {

class BrowserAction<I : Any, O : Any, AIC : AbstractDynamicPmaActivityContext<AIC, BIC>, BIC : TaskBuilderContext.BrowserContext<AIC, BIC>>(
    val action: TaskBuilderContext.AcceptedTask<AIC, BIC, I, O>
) : PmaAction<I, O, AIC>() {

}

class ServiceAction<I : Any, O : Any, C : AbstractDynamicPmaActivityContext<C, *>, S : AutomatedService>(

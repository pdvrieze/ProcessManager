...
class XmlDefineType : XPathHolder, IXmlDefineType {
  ...
  override fun deserializeAttribute(attributeNamespace: String?,
    ...
    when (attributeLocalName.toString()) {
      ...
      "refname" -> {
        setRefName(attributeValue.toString())
        return true
      }
  ...
  companion object {
    ...
    @Deprecated("Use normal factory method", ReplaceWith("XmlDefineType(export)", "nl.adaptivity.process.processModel.XmlDefineType"))

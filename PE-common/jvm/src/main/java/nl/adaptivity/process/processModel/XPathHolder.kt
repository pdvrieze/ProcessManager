...
//  @Volatile private var path: XPathExpression? = null // This is merely a cache.
  ...
  @Throws(XmlException::class)
  public actual override fun visitNamespaces(baseContext: NamespaceContext) {
    path = null
    if (pathString != null) {
  ...
  public actual override fun visitNamesInAttributeValue(referenceContext: NamespaceContext, owner: QName, attributeName: QName, attributeValue: CharSequence) {

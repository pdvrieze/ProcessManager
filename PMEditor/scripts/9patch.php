...
<?php
  ...
  $offx1=dp2px($argv[6],$dpi); $lenx1=dp2px($argv[7],$dpi);
  $offy1=dp2px($argv[8],$dpi); $leny1=dp2px($argv[9],$dpi);

  $offx2=dp2px($argv[10],$dpi); $lenx2=dp2px($argv[11],$dpi);
  $offy2=dp2px($argv[12],$dpi); $leny2=dp2px($argv[13],$dpi);
  ...
  imageline($dstimg, $offx1, 0, $offx1+$lenx1,0, $clr_black);
  imageline($dstimg, 0, $offy1, 0, $offy1+$leny1, $clr_black);

  imageline($dstimg, $offx2, $vsize+1, $offx2+$lenx2,$vsize+1, $clr_black);
  imageline($dstimg, $hsize+1, $offy2, $hsize+1, $offy2+$leny2, $clr_black);

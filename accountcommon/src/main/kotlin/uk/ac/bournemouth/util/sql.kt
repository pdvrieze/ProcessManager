...
inline fun <R> DataSource.connection(block: (ConnectionHelper) -> R): R =
    this.getConnection().use { connection(it, block) }
...
inline fun <R> DataSource.connection(username: String, password: String, block: (ConnectionHelper) -> R) = getConnection(username, password).use { connection(it, block) }
...
class ConnectionHelper constructor(val connection: Connection) {
   ...
   */
  inline fun <R> prepareStatement(@Language("SQL") sql: String, block: StatementHelper.() -> R): R = connection.prepareStatement(sql).use { block(StatementHelper(it)) }
   ...
   */
  @Throws(SQLException::class)
  inline fun <R> prepareStatement(@Language("SQL") sql: String, resultSetType: Int,
   ...
   */
  @Throws(SQLException::class)
  inline fun <R> prepareStatement(@Language("SQL") sql: String, autoGeneratedKeys: Int, block: (StatementHelper) -> R): R {
   ...
   */
  @Throws(SQLException::class)
  inline fun <R> prepareStatement(@Language("SQL") sql: String, columnIndexes: IntArray, block: (StatementHelper) -> R): R {
   ...
   */
  @Throws(SQLException::class)
  inline fun <R> prepareStatement(@Language("SQL") sql: String, columnNames: Array<out String>, block: (StatementHelper) -> R): R {

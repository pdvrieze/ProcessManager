...
inline public fun <R> DataSource.connection(block: (ConnectionHelper) -> R):R =
        this.getConnection().use { connection ->
            connection.autoCommit=false
            try {
                return block(ConnectionHelper(connection))
            } catch (e:Exception) {
                connection.rollback()
                throw e
            } finally {
...
public inline fun <R> DataSource.connection(username:String, password: String, block: (ConnectionHelper) -> R) = getConnection(username, password).use { connection -> ConnectionHelper(connection).use(block).apply {connection.commit()} }
...
class StatementHelper constructor (val statement: PreparedStatement) : PreparedStatement by statement {
    ...
    inline fun setParam(index:Int, value:Int?) = if (value==null) setNull(index, Types.INTEGER) else setInt(index, value)
    inline fun setParam(index:Int, value:Long?) = if (value==null) setNull(index, Types.BIGINT) else setLong(index, value)
    inline fun setParam(index:Int, value:String?) = if (value==null) setNull(index, Types.VARCHAR) else setString(index, value)
    inline fun setParam(index:Int, value:Boolean?) = if (value==null) setNull(index, Types.BOOLEAN) else setBoolean(index, value)
    inline fun setParam(index:Int, value:Byte?) = if (value==null) setNull(index, Types.TINYINT) else setByte(index, value)
    inline fun setParam(index:Int, value:Short?) = if (value==null) setNull(index, Types.SMALLINT) else setShort(index, value)
